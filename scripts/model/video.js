	...
	for (var i = 0; i < mediaCount; i++) {
		...
		for (var j = 0; j < partCount; j++) {
			...
			for (var k = 0; k < streamCount; k++) {
                ...
                if (streamType === '3') {
                     var substream = new Subtitles(stream);
                    // subtitlesArray[substream.index]["lang"] = substream.language;
                    // subtitlesArray[substream.index]["format"] = substream.format;
                      //if(substream.key)
                      subtitlesArray.push(substream);
