...
function PreferencesView() {
    ...
    function loadSettings() {
        ...
        document.getElementById('pref-bgart-enabled').innerHTML = (Settings.useBgArt()) ? ACTIVE_RADIO_BTN : INACTIVE_RADIO_BTN;
        document.getElementById('pref-blobs-enabled').innerHTML = (Settings.useBlobs()) ? ACTIVE_RADIO_BTN : INACTIVE_RADIO_BTN;
    ...
    this.onEnter = function () {
        ...
        else if (id === 'pref-bgart-enabled') {
            Settings.setBgArt(!Settings.useBgArt());
            document.getElementById('pref-bgart-enabled').innerHTML = (Settings.useBgArt()) ? ACTIVE_RADIO_BTN : INACTIVE_RADIO_BTN;
        }
        else if (id === 'pref-blobs-enabled') {
            Settings.setBlobs(!Settings.useBlobs());
            document.getElementById('pref-blobs-enabled').innerHTML = (Settings.useBlobs()) ? ACTIVE_RADIO_BTN : INACTIVE_RADIO_BTN;
        }
    };
