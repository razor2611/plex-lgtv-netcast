function lge() {
    ...
    this.createSettingsPlayer = function(media) {
        settingsmenu = new SimpleMenuView(media, "subs");
    }
    ...
    this.play = function () {
        ...
        if (video.playState == 0 || video.playState == 5) {
            ...
            video.play(1);
            $("#playBtn > img").remove();
            $('#playBtn').append('<img src="images/player/player_btn_icon/movie_btn_icon_pause_n.png" alt="pauseImg" class="playBtn" align="center" />');
        }
        if (video.playState == 2) {
            ...
            video.play(0);
            $("#playBtn > img").remove();
            $('#playBtn').append('<img src="images/player/player_btn_icon/movie_btn_icon_play_n.png" alt="playImg" class="playBtn" align="center" />');
        }
    ...
    */
    ...
    addControls = function (container) {
        $(container)
            ...
            + '</div>' + '<div id="lgVid_control">' + '<div id="stop" class="ctrlButtonNormalLeft"><div class="bottomControlBtn" align="center" ><img src="images/player/player_btn_icon/movie_btn_icon_stop_n.png" alt="stopImg" class="stopBtn"/></div></div>' + '<div id="play" class="ctrlButtonNormal"><div id="playBtn" class="bottomControlBtn" align="center" ><img src="images/player/player_btn_icon/movie_btn_icon_play_n.png" alt="playImg"  class="playBtn" align="center" /></div></div>' + '<div id="rewind" class="ctrlButtonNormal"><div class="bottomControlBtn" align="center"><img src="images/player/player_btn_icon/movie_btn_icon_rewind_n.png" alt="rewindImg" class="rewindBtn"/></div></div>' + '<div id="forward" class="ctrlButtonNormal"><div class="bottomControlBtn" align="center"><img src="images/player/player_btn_icon/movie_btn_icon_forward_n.png" alt="forwardImg" class="forwardBtn"/></div></div>' + '<div id="playersettings" class="ctrlButtonNormal"><div class="bottomControlBtn" align="center"><img src="images/player/player_btn_icon/movie_btn_icon_chapter_n.png" alt="screenImg" class="settingsBtn"/></div></div>' + '<div id="option" class="ctrlButtonNormal"><div class="bottomControlBtn" align="center"><img src="images/player/player_btn_icon/movie_btn_icon_option_n.png" alt="optionImg" class="optionBtn"/></div></div>' + '</div>' + '</div>' + ' <div id="ballCoverage"><div id="progressBall" class="progressBallInitial" > </div></div>' + '</div>');
        $("#lgVid_control").children().each(function (i) {
            switch ($(this).attr("id")) {
                case "stop":
