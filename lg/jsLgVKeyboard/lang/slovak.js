 ...
 * label string seting
 */
var STR_VK_CLEAR = "<p id='wkk_key_clear_p'>Odstrániť<br>všetko</p>";
...
function changeKeyValue(category) {
	switch(category)
	{
		...
		case 'shift':
			...
			lgKb.setKeyText("wkk_key_103", "E", ["E","É"]);
			...
			lgKb.setKeyText("wkk_key_109", "O", ["O","Ó","Ô"]);
			...
			lgKb.setKeyText("wkk_key_201", " ");
			lgKb.setKeyText("wkk_key_202", "A", ["A","Á","Ä"]);
			lgKb.setKeyText("wkk_key_203", "S", ["S","Š"]);
			lgKb.setKeyText("wkk_key_204", "D", ["D","Ď"]);
			...
			lgKb.setKeyText("wkk_key_210", "L", ["L", "Ľ"]);
			lgKb.setKeyText("wkk_key_211", ";");
			lgKb.setKeyText("wkk_key_212", "'");
			lgKb.setKeyText("wkk_key_213", " ");
			lgKb.setKeyText("wkk_key_214", " ");
