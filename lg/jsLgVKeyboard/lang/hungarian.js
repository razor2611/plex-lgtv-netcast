 ...
 * label string seting
 */
var STR_VK_CLEAR = "<p id='wkk_key_clear_p'>Az összes<br>törlése</p>";
...
function changeKeyValue(category) {
	switch(category)
	{
		...
		case 'shift':
			...
			lgKb.setKeyText("wkk_key_107", "U", ["U","Ú","Ü","Ű"]);
			lgKb.setKeyText("wkk_key_108", "I", ["I","Í"]);
			lgKb.setKeyText("wkk_key_109", "O", ["O","Ó","Õ","Ö","Ö"]);
		...
		default :
			...
			lgKb.setKeyText("wkk_key_107", "u", ["u","ú","ü","ű"]);
			lgKb.setKeyText("wkk_key_108", "i", ["i","í"]);
			lgKb.setKeyText("wkk_key_109", "o", ["o","ó","õ","ö","ő"]);
			lgKb.setKeyText("wkk_key_110", "p");
			lgKb.setKeyText("wkk_key_111", "[");
			lgKb.setKeyText("wkk_key_112", "]");
			lgKb.setKeyText("wkk_key_113", "\\");
