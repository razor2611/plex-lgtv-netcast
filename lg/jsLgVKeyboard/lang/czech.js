...
function changeKeyValue(category) {
	switch(category)
	{
		...
		case 'shift':
			...
			lgKb.setKeyText("wkk_key_103", "E",["E","É","Ě"]);
			lgKb.setKeyText("wkk_key_104", "R",["R","Ř"]);
			lgKb.setKeyText("wkk_key_105", "T",["T","Ť"]);
			lgKb.setKeyText("wkk_key_106", "Y",["Y","Ý"]);
			lgKb.setKeyText("wkk_key_107", "U",["U","Ú","Ů"]);
			lgKb.setKeyText("wkk_key_108", "I",["I","Í"]);
			lgKb.setKeyText("wkk_key_109", "O",["O","Ó"]);
			...
			lgKb.setKeyText("wkk_key_201", " ");
			lgKb.setKeyText("wkk_key_202", "A",["A","Á"]);
			...
			lgKb.setKeyText("wkk_key_308", "N",["N","Ň"]);
