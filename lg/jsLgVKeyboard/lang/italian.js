 ...
 * label string seting
 */
var STR_VK_CLEAR = "Elimina tutti";
...
function changeKeyValue(category) {
	switch(category)
	{
		...
		case 'shift':
			...
			lgKb.setKeyText("wkk_key_103", "E", ["E","È","É"]);
			lgKb.setKeyText("wkk_key_104", "R");
			lgKb.setKeyText("wkk_key_105", "T");
			lgKb.setKeyText("wkk_key_106", "Y");
			lgKb.setKeyText("wkk_key_107", "U", ["U","Ù","Ú"]);
			lgKb.setKeyText("wkk_key_108", "I", ["I","Ì","Í","Î"]);
			lgKb.setKeyText("wkk_key_109", "O", ["O","Ò","Ó"]);
			lgKb.setKeyText("wkk_key_110", "P");
			lgKb.setKeyText("wkk_key_111", "é");
			lgKb.setKeyText("wkk_key_112", "*");
			lgKb.setKeyText("wkk_key_113", " ");
			lgKb.setKeyText("wkk_key_114", " ");
			
			lgKb.setKeyText("wkk_key_201", " ");
			lgKb.setKeyText("wkk_key_202", "A", ["A","À"]);
		...
		default :
			...
			lgKb.setKeyText("wkk_key_106", "y");
			lgKb.setKeyText("wkk_key_107", "u", ["u","ù","ú"]);
			lgKb.setKeyText("wkk_key_108", "ì", ["ì","ì","í","î"]);
			lgKb.setKeyText("wkk_key_109", "o", ["o","ò","ó"]);
			lgKb.setKeyText("wkk_key_110", "p");
			lgKb.setKeyText("wkk_key_111", "è");
			lgKb.setKeyText("wkk_key_112", "+");
			lgKb.setKeyText("wkk_key_113", " ");
			lgKb.setKeyText("wkk_key_114", " ");
			...
			lgKb.setKeyText("wkk_key_209", "k");
			lgKb.setKeyText("wkk_key_210", "l");
			lgKb.setKeyText("wkk_key_211", "ò");
			lgKb.setKeyText("wkk_key_212", "à");
			lgKb.setKeyText("wkk_key_213", "ù");
			lgKb.setKeyText("wkk_key_214", " ");
