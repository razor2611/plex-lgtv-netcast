...
function changeKeyValue(category) {
	switch(category)
	{
		...
		case 'shift':
			...
			lgKb.setKeyText("wkk_key_105", "T", ["T","Ţ"]);
			lgKb.setKeyText("wkk_key_106", "Y");
			lgKb.setKeyText("wkk_key_107", "U");
			lgKb.setKeyText("wkk_key_108", "I", ["I","Î"]);
			...
			lgKb.setKeyText("wkk_key_201", " ");
			lgKb.setKeyText("wkk_key_202", "A", ["A","Ă","Â"]);
			lgKb.setKeyText("wkk_key_203", "S", ["S","Ş"]);
