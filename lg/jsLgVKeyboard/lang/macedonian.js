...
function changeKeyValue(category) {
	switch(category)
	{
		...
		case 'shift':
			...
			lgKb.setKeyText("wkk_key_101", "Љ");
			lgKb.setKeyText("wkk_key_102", "Њ");
			lgKb.setKeyText("wkk_key_103", "E");
			lgKb.setKeyText("wkk_key_104", "P");
			lgKb.setKeyText("wkk_key_105", "T");
			lgKb.setKeyText("wkk_key_106", "S");
			lgKb.setKeyText("wkk_key_107", "У");
			lgKb.setKeyText("wkk_key_108", "И");
			lgKb.setKeyText("wkk_key_109", "O");
			lgKb.setKeyText("wkk_key_110", "П");
			lgKb.setKeyText("wkk_key_111", "Ш");
			lgKb.setKeyText("wkk_key_112", "Ѓ");
			lgKb.setKeyText("wkk_key_113", " ");
			lgKb.setKeyText("wkk_key_114", " ");
			
			lgKb.setKeyText("wkk_key_201", " ");
			lgKb.setKeyText("wkk_key_202", "A");
			lgKb.setKeyText("wkk_key_203", "C");
			lgKb.setKeyText("wkk_key_204", "Д");
			lgKb.setKeyText("wkk_key_205", "Ф");
			lgKb.setKeyText("wkk_key_206", "Г");
			lgKb.setKeyText("wkk_key_207", "X");
			lgKb.setKeyText("wkk_key_208", "J");
			lgKb.setKeyText("wkk_key_209", "K");
			lgKb.setKeyText("wkk_key_210", "Л");
			lgKb.setKeyText("wkk_key_211", "Ч");
			lgKb.setKeyText("wkk_key_212", "Ќ");
			lgKb.setKeyText("wkk_key_213", " ");
			lgKb.setKeyText("wkk_key_214", " ");
			
			lgKb.setKeyText("wkk_key_301", " ");
			lgKb.setKeyText("wkk_key_302", " ");
			lgKb.setKeyText("wkk_key_303", "З");
			lgKb.setKeyText("wkk_key_304", "Џ");
			lgKb.setKeyText("wkk_key_305", "Ц");
			lgKb.setKeyText("wkk_key_306", "B");
			lgKb.setKeyText("wkk_key_307", "Б");
			lgKb.setKeyText("wkk_key_308", "H");
			lgKb.setKeyText("wkk_key_309", "M");
			lgKb.setKeyText("wkk_key_310", "Ж");
			lgKb.setKeyText("wkk_key_311", " ");
			lgKb.setKeyText("wkk_key_312", " ");
			lgKb.setKeyText("wkk_key_313", " ");
			lgKb.setKeyText("wkk_key_314", " ");
		...
		default :
			...
			lgKb.setKeyText("wkk_key_201", " ");
			lgKb.setKeyText("wkk_key_202", "a");
			lgKb.setKeyText("wkk_key_203", "с");
			lgKb.setKeyText("wkk_key_204", "д");
			lgKb.setKeyText("wkk_key_205", "ф");
			lgKb.setKeyText("wkk_key_206", "г");
			lgKb.setKeyText("wkk_key_207", "х");
			lgKb.setKeyText("wkk_key_208", "ј");
			lgKb.setKeyText("wkk_key_209", "к");
			lgKb.setKeyText("wkk_key_210", "л");
			lgKb.setKeyText("wkk_key_211", "ч");
			lgKb.setKeyText("wkk_key_212", "ќ");
			lgKb.setKeyText("wkk_key_213", " ");
			...
			lgKb.setKeyText("wkk_key_304", "џ");
			lgKb.setKeyText("wkk_key_305", "ц");
			lgKb.setKeyText("wkk_key_306", "в");
			lgKb.setKeyText("wkk_key_307", "б");
			lgKb.setKeyText("wkk_key_308", "н");
			lgKb.setKeyText("wkk_key_309", "м");
			lgKb.setKeyText("wkk_key_310", "ж");
			lgKb.setKeyText("wkk_key_311", " ");
			lgKb.setKeyText("wkk_key_312", " ");
			lgKb.setKeyText("wkk_key_313", " ");
