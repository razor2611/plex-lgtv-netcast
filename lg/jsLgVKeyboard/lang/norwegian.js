...
function changeKeyValue(category) {
	switch(category)
	{
		...
		case 'shift':
			...
			lgKb.setKeyText("wkk_key_109", "O", ["O", "Ó", "Ò", "Ô", "Ø"]);
			...
			lgKb.setKeyText("wkk_key_201", " ");
			lgKb.setKeyText("wkk_key_202", "A", ["A", "À", "Å", "Æ"]);
			...
			lgKb.setKeyText("wkk_key_211", "Ø");
			lgKb.setKeyText("wkk_key_212", "Æ");
			lgKb.setKeyText("wkk_key_213", "'");
			lgKb.setKeyText("wkk_key_214", " ");
