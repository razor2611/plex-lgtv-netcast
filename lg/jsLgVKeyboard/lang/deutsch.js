 ...
 * label string seting
 */
var STR_VK_CLEAR = "<p id='wkk_key_clear_p'>Alles<br>verwijderen</p>";
...
function changeKeyValue(category) {
	switch(category)
	{
		...
		case 'shift':
			...
			lgKb.setKeyText("wkk_key_103", "E",["E","È","É","Ë","Ệ"]);
			lgKb.setKeyText("wkk_key_104", "R");
			lgKb.setKeyText("wkk_key_105", "T");
			lgKb.setKeyText("wkk_key_106", "Y");
			lgKb.setKeyText("wkk_key_107", "U",["U","Ú","Ù","Ü","Û","Ü"]);
			lgKb.setKeyText("wkk_key_108", "I",["I","Í","Ì","Ï","Î"]);
			lgKb.setKeyText("wkk_key_109", "O",["O","Ó","Ò","Ö","Ô","Õ"]);
			...
			lgKb.setKeyText("wkk_key_201", " ");
			lgKb.setKeyText("wkk_key_202", "A",["A","Ấ","Ầ","Ầ","Ä","Ậ","Ã"]);
		...
		default :
			...
			lgKb.setKeyText("wkk_key_101", "q");
			lgKb.setKeyText("wkk_key_102", "w");
			lgKb.setKeyText("wkk_key_103", "e",["e", "ë"]);
			lgKb.setKeyText("wkk_key_104", "r");
			lgKb.setKeyText("wkk_key_105", "t");
			lgKb.setKeyText("wkk_key_106", "y");
			lgKb.setKeyText("wkk_key_107", "u",["u", "ü"]);
			lgKb.setKeyText("wkk_key_108", "i",["i", "ï"]);
			lgKb.setKeyText("wkk_key_109", "o",["o", "ö"]);
			lgKb.setKeyText("wkk_key_110", "p");
			lgKb.setKeyText("wkk_key_111", "[");
			lgKb.setKeyText("wkk_key_112", "]");
			lgKb.setKeyText("wkk_key_113", "\\");
			...
			lgKb.setKeyText("wkk_key_201", " ");
			lgKb.setKeyText("wkk_key_202", "a",["a", "ä"]);
			lgKb.setKeyText("wkk_key_203", "s");
			lgKb.setKeyText("wkk_key_204", "d");
			lgKb.setKeyText("wkk_key_205", "f");
			lgKb.setKeyText("wkk_key_206", "g");
